...
_NS_INLINE _Dst bridgingCast(_Src pObj)
{
#if __OBJC__
...
_NS_INLINE void MTK::View::setDelegate( const MTK::ViewDelegate* pDelegate )
{
	...
	void (*drawDispatch)( NS::Value*, SEL, MTK::View* ) = []( NS::Value* pSelf, SEL _cmd, MTK::View* pMTKView ){
		auto pDel = reinterpret_cast< MTK::ViewDelegate* >( pSelf->pointerValue() );
		pDel->drawInMTKView( pMTKView );
	};
	...
	objc_setAssociatedObject( NS::Object::bridgingCast< id >(pWrapper), "mtkviewdelegate_cpp", NS::Object::bridgingCast< id >(pWrapper), OBJC_ASSOCIATION_RETAIN_NONATOMIC );
