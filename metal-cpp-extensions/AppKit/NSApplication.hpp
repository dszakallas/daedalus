...
_NS_INLINE void NS::Application::setDelegate( const ApplicationDelegate* pAppDelegate )
{
	...
	class_addMethod( NS::Object::bridgingCast<Class>(_NS_PRIVATE_CLS( NSValue )), _APPKIT_PRIVATE_SEL( applicationWillFinishLaunching_ ), (IMP)willFinishLaunching, "v@:@" );
	class_addMethod( NS::Object::bridgingCast<Class>(_NS_PRIVATE_CLS( NSValue )), _APPKIT_PRIVATE_SEL( applicationDidFinishLaunching_ ), (IMP)didFinishLaunching, "v@:@" );
	class_addMethod( NS::Object::bridgingCast<Class>(_NS_PRIVATE_CLS( NSValue )), _APPKIT_PRIVATE_SEL( applicationShouldTerminateAfterLastWindowClosed_), (IMP)shouldTerminateAfterLastWindowClosed, "B@:@" );
